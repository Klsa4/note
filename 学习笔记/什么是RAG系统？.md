...
![无法获取该图片](https://oss.open8gu.com/image-20260213111819411.png "无法获取该图片")  
...
![无法获取该图片](https://oss.open8gu.com/image-20260213112325650.png "无法获取该图片")  
...
![无法获取该图片|697](https://oss.open8gu.com/RAG_CASE.png "无法获取该图片")  
...
![无法获取该图片|519](https://oss.open8gu.com/iShot_2026-02-08_21.46.14.png "无法获取该图片")

## 2. RAG 核心流程

RAG 全链路图：`ingest → chunk → embed → index → retrieve → answer`。

![无法获取该图片](https://oss.open8gu.com/image-20260213144311586.png "无法获取该图片")  
...
![无法获取该图片](https://oss.open8gu.com/20260204%E5%8F%91%E7%A8%BF_1.png "无法获取该图片")  
...
![无法获取该图片](https://oss.open8gu.com/image-20260213171649839.png "无法获取该图片")  
